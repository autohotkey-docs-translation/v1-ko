...
toc = [
  {label:"오토핫키 소개",path:"AutoHotkey.htm"},
  {label:"자습서",path:"Tutorial.htm"},
  {label:"FAQ (자주 묻는 질문)",path:"FAQ.htm"},
  {label:"명령어와 함수 인덱스",path:"commands/index.htm"},
  {label:"예제 스크립트",path:"scripts/index.htm"},
  {label:"최근 변경사항",path:"AHKL_ChangeLog.htm"},
  {label:"기본적인 사용법과 구문",children:
  [
    {label:"핫키",path:"Hotkeys.htm"},
    {label:"핫스트링 & 자동-교체",path:"Hotstrings.htm"},
    {label:"키와 버튼을 리맵하기",path:"misc/Remap.htm"},
    {label:"키 리스트 (키보드, 마웃, 조이스틱)",path:"KeyList.htm"},
    {label:"스크립트",path:"Scripts.htm"},
    {label:"변수와 표현식",path:"Variables.htm"},
    {label:"함수",path:"Functions.htm"},
    {label:"디버깅 클라이언트 (DBGp)",path:"AHKL_DBGPClients.htm"},
    {label:"객체",path:"Objects.htm",children:
    [
      {label:"기본 사용법",path:"Objects.htm#Usage"},
      {label:"고급 사용법",path:"Objects.htm#Extended_Usage"},
      {label:"맞춤 객체",path:"Objects.htm#Custom_Objects"},
      {label:"기본 베이스 객체",path:"Objects.htm#Default_Base_Object"},
      {label:"객체의 구현",path:"Objects.htm#Implementation"},
      {label:"객체",path:"objects/Object.htm"},
      {label:"열거 객체",path:"objects/Enumerator.htm"},
      {label:"파일 객체",path:"objects/File.htm"},
      {label:"함수 객체",path:"objects/Functor.htm"}
    ]}
  ]},
  {label:"AutoHotkey 1.1로 이주하기 (AutoHotkey_L)",children:
  [
    {label:"AutoHotkey_L 새 특징",path:"AHKL_Features.htm"},
    {label:"스크립트 호환성",path:"Compat.htm"}
  ]},
  {label:"환경 관리",children:
  [
  ...
  {label:"파일, 디렉토리, 그리고 디스크 관리",children:
  [
    ...
    {label:"Loop (파일 & 폴더)",path:"commands/LoopFile.htm"},
    {label:"Loop (파일 내용 읽기)",path:"commands/LoopReadFile.htm"},
    {label:"SetWorkingDir",path:"commands/SetWorkingDir.htm"},
    {label:"SplitPath",path:"commands/SplitPath.htm"}
  ]},
  {label:"실행 흐름",children:
  [
    ...
    {label:"회돌이 명령어",path:"commands/Loop.htm",children:
    [
  ...
  {label:"내장 함수",path:"Functions.htm",children:
  [
  ...
  {label:"GUI, MsgBox, InputBox & 기타 대화상자",children:
  [
    {label:"FileSelectFile",path:"commands/FileSelectFile.htm"},
    {label:"FileSelectFolder",path:"commands/FileSelectFolder.htm"},
  ...
  {label:"마우스와 키보드",children:
  [
    {label:"핫키와 핫스트링",path:"Hotkeys.htm",children:
    [
...
translate = {
  ...
  cdSelectBtn: "선택",
  cdDownloadBtn: "내려받기",
  verToolTipAHK_L: "다음에 적용됩니다:\nAutoHotkey_L Revision {0} 이후\nAutoHotkey v1.0.90.00 이후",
  verToolTipDefault: "AutoHotkey {0} 이후에 적동됩니다",
  tutLocalMessage: "이 문서를 하드에서 보고 있기 때문에, 아마도 이미 AutoHotkey가 설치되어 있을 것이고 섹션 b로 건너 뛰어도 됩니다."
};
